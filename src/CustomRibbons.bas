...
Function CVribbons_xml() As String
    ...
    xmlText = xmlText & "<mso:button id=""ExportCode"" label=""Export Code"" imageMso=""SourceControlCheckOut"" onAction=""Build.testExport"" visible=""true""/>"
    xmlText = xmlText & "<mso:button id=""ImportCode"" label=""Import Code"" imageMso=""SourceControlCheckIn"" onAction=""Build.testImport"" visible=""true""/>"
    xmlText = xmlText & "</mso:group>"
